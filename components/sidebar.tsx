          ...
          return (
            <li key={item.href}>
              ...
              >
                <div
                  className={cn(
                    "absolute left-0 top-1/2 h-6 w-[3px] -translate-y-1/2 rounded-r-full bg-sky-400 transition-all duration-300",
                    isActive
  ...
  function ThemeButton() {
    ...
    return (
      <button
        ...
        className="group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-left transition hover:bg-muted/40"
      >
